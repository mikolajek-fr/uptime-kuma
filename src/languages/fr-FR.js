export default {
    ...
    DateTime: "Heure",
    Message: "Messages",
    "No important events": "Pas d'évènements importants",
    Resume: "Reprendre",
    Edit: "Modifier",
    Delete: "Supprimer",
    ...
    "Allow indexing": "Autoriser l'indexation par les moteurs de recherche",
    "Discourage search engines from indexing site": "Refuser l'indexation par les moteurs de recherche",
    ...
    backupDescription3: "Les données sensibles telles que les jetons de notification sont incluses dans le fichier d'export, veuillez les conserver soigneusement.",
    ...
    wayToGetLineChannelToken: "Premièrement accédez à {0}, créez un provider et un salon (Messaging API), puis vous pourrez avoir le Token d'accès du salon ainsi que l'Identifiant utilisateur depuis le même menu.",
    "Icon URL": "Icon URL",
    ...
    emailCustomSubject: "Sujet personnalisé",
    clicksendsms: "ClickSend SMS",
    checkPrice: "Vérification {0} tarifs :",
    apiCredentials: "Crédentials de l'API",
    octopushLegacyHint: "Utilisez-vous l'ancienne version d'Octopush (2011-2020) ou la nouvelle version ?",
    ...
    pushOptionalParams: "Paramètres optionnels : {0}",
